    ...
    <nav class="navbar navbar-light bg-light border-bottom sticky-top">
      <div class="container d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center gap-3">
          ...
          <!-- Page-specific nav buttons (Email / Login / Tables)
               Rules:
               - /login        -> Email + Tables
               - /email        -> Login + Tables
               - /interactive… -> Email + Login
               - other pages   -> none
          ...
          <!-- Back button on Student/Teacher area -->
          ...
          <div v-if="isLoggedIn" class="dropdown">
            <button
              ...
              <span class="user-name">{{ currentUserName }} 
                <span
                  v-if="role"
...
export default {
  ...
  computed: {
    // Back button only on area pages
    showBackBtn() {
    ...
    // ---- Page detection (name or path; resilient to renames) ----
    page() {
    ...
    // ---- Buttons to show at top-right for the current page ----
    navButtons() {
      let items = []
      switch (this.page) {
        case 'login':
        ...
        case 'tables':
          ...
          break
        default:
          // On other pages (e.g., /resources, /student, /teacher) show no extra buttons
          items = []
      }
