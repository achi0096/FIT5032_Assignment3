        ...
        <form @submit.prevent="submitForm" class="row g-3" novalidate>
          ...
          <div v-if="tab === 'signup'" class="col-12">
            ...
            <input id="name" v-model.trim="name" type="text" class="form-control" autocomplete="name"
              @blur="validateName(false)" @input="touched.name = true; validateName(false); onSignUpInput()" />
          ...
          <div class="col-12">
            ...
            <input id="email" v-model.trim="email" type="email" class="form-control" @blur="validateEmail(false)"
          ...
          <div v-if="tab === 'signup'" class="col-12">
            ...
            <div class="pw-wrap">
              <input id="cpw" v-model="confirmPassword" :type="showConfirm ? 'text' : 'password'"
                class="form-control with-eye" @blur="validateConfirm(false)"
          ...
          <!-- Sign Up: show Clear + Create Account -->
...
export default {
  ...
  methods: {
    ...
    clearSignUp() {
      ...
      this.errors = { name: null, email: null, password: null, confirm: null };
      if (this.touched) this.touched = { name: false, email: false, password: false, confirm: false };
      if (this.signupSubmitted !== undefined) this.signupSubmitted = false;
